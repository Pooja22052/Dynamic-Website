...
<html lang="en">
  ...
  <style >
    ...
    background: -webkit-linear-gradient(to right, #008800, #F0F2F0);  /* Chrome 10-25, Safari 5.1-6 */
    background: linear-gradient(to right, #008800, #F0F2F0); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
}
...
.list-group-item.active {
    ...
    color: #fff;
    background: #F0F2F0; 
    background: -webkit-linear-gradient(to right, #008800, #F0F2F0);
    background: linear-gradient(to right, #008800, #F0F2F0);
    border-color: #c3c3c3;
}
.text-primary {
                ...
                <div class="col-sm-4" style="left: 18%;margin-top: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <i class="fa fa-plus-circle fa-stack-1x fa-inverse"></i> </span>
          ...
          <div class="col-md-4"><label>Doctor Name:</label></div>
                  ...
                  <div class="col-md-8">
                   <select name="special" class="form-control" id="special" required="required">
                      ...
                      <option value="Facial" name="spec">Facial</option>
                      <option value="Women" name="spec">Women</option>
                      <option value="Other" name="spec">Other</option>
