...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-hospital-o" aria-hidden="true"></i>   Yogeshwar Ayurveda and Panchakarma Centre </a>
  ...
  <style >
    .bg-primary {
    /* background: -webkit-linear-gradient(left, #008800, #00c6ff); */
